...
@section('body')
    ...
    <div class="background-gradient gradient-green">
        ...
        During the preliminaries, the teams will follow a round-robin rotation of five minute heats, to try to allow for every school to have the opportunity to play either with or against every other school. The scores accumulated during the preliminary round-robin, which takes up the Friday of the competition, by each individual school will determine their placement. The top teams, along with the teams who make up their scores in the knockout rounds early Saturday morning, move on to the quarter-finals. The top 8 teams compete in the semi-finals, of which the top four teams complete one last round-robin amongst themselves in the finals to determine who will be victorious.
    </div>
    ...
    <div class="background-gradient gradient-green">
        ...
        There are three types of targets present on the field, each with different points attributed: 10, 20 or 40 depending on the container height. <br/> <br/>
        At the end of each heat, the points are calculated by counting the amount of yellow game pieces in each target multiplied by the points attributed to each target for the yellow team�s score and the same process using blue game pieces for the blue team�s score, regardless of which team is responsible for putting the game piece in the target.
    </div>
